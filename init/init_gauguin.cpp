...
void load_gauguin() {
    ...
    property_override("ro.build.description", "gauguin-user 11 RKQ1.200826.002 V12.0.5.0.RJSMIXM release-keys");
    property_override("ro.build.fingerprint", "Xiaomi/gauguin/gauguin:11/RKQ1.200826.002/V12.0.5.0.RJSMIXM:user/release-keys");
}
...
void load_gauguininpro() {
    ...
    property_override("ro.build.description", "gauguininpro-user 11 RKQ1.200826.002 V12.0.2.0.RJSINXM release-keys");
...
void load_gauguinpro() {
    ...
    property_override("ro.build.description", "gauguinpro-user 11 RKQ1.200826.002 V12.0.2.0.RJSCNXM release-keys");
    property_override("ro.build.fingerprint", "Redmi/gauguinpro/gauguinpro:11/RKQ1.200826.002/V12.0.2.0.RJSCNXM:user/release-keys");
}
